...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{-- nell'attributo action del form inserisco la rotta update per immagazzinare tutti i dati inseriti nel form e l'id del singolo tag che sarà modificata --}}
            ...
            <form action="{{route('admin.tags.update', $tag->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    {{-- come attributo al metodo old(), oltre al name, passo anche il tag attuale salvato a db --}}
